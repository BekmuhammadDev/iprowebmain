...
const vacansy = () => {
  ...
  return (
    <>
      <Header />
      <main className='overflow-hidden bg-gradient-to-br from-[#0D1128] to-[#1C1F3A] text-white font-sans'>
...
>
  ...
  >
    Apply now
        ...
        <section className='mt-20 container mx-auto px-4 sm:px-6 md:px-10 py-10 sm:py-16 md:py-20' data-aos="fade-up">
          <div>
          ...
          <div className='mt-10'>
            ...
            <ul className='list-disc list-inside space-y-2 text-gray-300'>
              <li>Knowledge of the application structure of PWA(Progressive Web App), SPA(Single Page Application), SSR(Server-Side Rendering), MF(Mutual Funds);</li>
              ...
              <li>Knowledge of JavaScript and its basic concepts (prototypical inheritance, event loop, closures, this keyword, etc.);</li>
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-80 flex items-center justify-center p-4">
    ...
    {/* Modal konteyner */}
    <div className="relative bg-[#1E2238] rounded-xl shadow-xl w-full max-w-3xl overflow-y-auto max-h-[90vh] p-6">
      
      {/* Yopish tugmasi – har doim modal ichidagi yuqori chap burchakda */}
      <button
        onClick={() => setShowModal(false)}
        className="absolute top-4 left-4 text-white hover:text-red-500 transition text-3xl"
        aria-label="Yopish"
      >
        <IoMdClose />
      </button>

      <h2 className="text-2xl sm:text-3xl text-center font-bold text-white mb-6">Ariza topshirish</h2>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-white">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="flex items-center justify-center w-full">
            <label htmlFor="resume" className="flex gap-3 items-center cursor-pointer px-5 py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-md font-semibold transition">
              <FaFileDownload />
              CV ni yuklang
            </label>
            <input
