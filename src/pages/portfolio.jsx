            ...
            <main className='mt-20'>
                ...
                <section>
                    <div className='container mx-auto mb-44'>
                        ...
                        <div class="flex items-center flex-col md:flex-row gap-0 overflow-hidden rounded-[8px] py-12 bg-[#16182B] px-5 -space-x-16">

                            <div className='relative'>
                                <h1 className='text-5xl font-bold text-white mb-[10px] text-center md:text-left'>Mobile</h1>
                                <p className='text-base font-medium text-white md:mb-10 mb-0 text-center md:text-left'>Our team created over 20+ websites including online <br />  shops, CRM, and other type for business owners. Just click the button bellow to see all projects.</p>
                                <button className='relative top-[320px] md:top-0 bg-white text-blue-600 py-2 px-5 uppercase text-base w-full md:w-[172px] font-bold shadow-lg drop-shadow-[0_5px_20px_rgba(0,112,244,0.8)]'>View projects</button>
                            </div>
