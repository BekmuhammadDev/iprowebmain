        ...
        <section className="relative z-10 py-10 px-4 sm:px-8 md:px-10">
          <div className="container mx-auto">
            <motion.h1
              ...
              className="text-center md:text-left text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-500 text-[42px] md:text-[80px] font-extrabold leading-[1.1] drop-shadow-[0_5px_30px_rgba(0,112,244,0.9)] mb-16"
            >
              {t("vacansy")}
            </motion.h1>
