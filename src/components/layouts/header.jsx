                    ...
                    <ul className="hidden lg:flex gap-10">
                        {[
                            ...
                            >
                                ...
                                {/* Underline effect */}
                                <span
                                    className="absolute bottom-0 left-0 w-0 h-[2px] bg-blue-500 transition-all duration-300 group-hover:w-full"></span>
                            </NavLink>
                        ))}
                    </ul>
                    ...
                    <div className="relative flex items-center gap-5">
                        ...
                        <div className="flex items-center md:gap-7 relative">
                            ...
                            <div className="relative dropdown">
                                ...
                                {openDropdown === "notif" && (
                                    <div
                                        className="absolute top-12 -left-20 border w-[230px] text-white rounded-lg shadow-lg">
                                        <MdArrowDropUp
                                            className="absolute -bottom-5 left-16 text-[#16182B] text-[48px]"/>
