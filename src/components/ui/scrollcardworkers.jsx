...
export default function TestimonialSlider() {
    ...
    return (
        <div className="flex flex-col items-center space-y-10 gap-y-28 px-7  md:gap-y-0 py-32 mb-[338px] bg-[#16182B] overflow-hidden p-4 md:p-40">
            {testimonials.map((item, index) => (
                <div
                    key={index}
                    data-index={index}
                    className={`testimonial-card relative mt-20 h-[155px]  w-full md:w-[550px] p-2 shadow-lg transition-all duration-700 flex flex-col md:flex-row items-center 
                        ${activeIndex >= index
                            ? "opacity-100 scale-105 bg-[#0A0F1F] text-white shadow-[0px_5px_20px_10px_rgba(59,130,246,0.5)]"
